...
declare class AdditionalWindowObject extends UObject { 
	bIsStandaloneGame: boolean;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AdditionalWindowObject;
	static Find(Outer: UObject, ResourceName: string): AdditionalWindowObject;
	static StaticClass: any;
	static GetClassObject(): Class;
	static GetDefaultObject(): AdditionalWindowObject;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AdditionalWindowObject;
	static RemoveWidgetFromAddtionalWindow(WorldContextObject: UObject,InWidget: UserWidget): boolean;
	static RemoveAllWidgetsFromAdditionalWindow(WorldContextObject: UObject): boolean;
	static DestroyNewWindow(WorldContextObject: UObject): void;
	static CreateNewWindow(WorldContextObject: UObject): void;
	static AddToAdditionalWindow(WorldContextObject: UObject,InWidget: UserWidget,ZOrder: number): boolean;
	static C(Other: UObject): AdditionalWindowObject;
}
...
declare class MediaSubtitlesFactory extends Factory { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): MediaSubtitlesFactory;
	static Find(Outer: UObject, ResourceName: string): MediaSubtitlesFactory;
	static StaticClass: any;
	static GetClassObject(): Class;
	static GetDefaultObject(): MediaSubtitlesFactory;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MediaSubtitlesFactory;
	static C(Other: UObject): MediaSubtitlesFactory;
}

declare class MediaSubtitlesFactoryNew extends Factory { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): MediaSubtitlesFactoryNew;
	static Find(Outer: UObject, ResourceName: string): MediaSubtitlesFactoryNew;
	static StaticClass: any;
	static GetClassObject(): Class;
	static GetDefaultObject(): MediaSubtitlesFactoryNew;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MediaSubtitlesFactoryNew;
	static C(Other: UObject): MediaSubtitlesFactoryNew;
}
...
declare class MobileInstalledContent extends UObject { 
	...
	static C(Other: UObject): MobileInstalledContent;
}
...
declare class MobilePendingContent extends MobileInstalledContent { 
	...
	static C(Other: UObject): MobilePendingContent;
}
...
declare class MobilePatchingLibrary extends BlueprintFunctionLibrary { 
	...
	static C(Other: UObject): MobilePatchingLibrary;
}
...
declare class JavascriptGraphAssetGraphSchema extends EdGraphSchema { 
	OnDetermineWiringStyle: UnrealEngineDelegate<(A: JavascriptEdGraphPin, B: JavascriptEdGraphPin, Params: JavascriptConnectionParams) => void>;
	OnComputeSplineTangent: UnrealEngineDelegate<(A: Vector2D, B: Vector2D) => Vector2D>;
	OnDrawSplineWithArrow: UnrealEngineDelegate<(A: Vector2D, B: Vector2D, Params: JavascriptConnectionParams) => void>;
	OnDrawSplineWithArrow_Geom: UnrealEngineDelegate<(A: Geometry, B: Geometry, Params: JavascriptConnectionParams) => void>;
	OnDrawPreviewConnector: UnrealEngineDelegate<(PinGeometry: Geometry, StartPoint: Vector2D, EndPoint: Vector2D, Pin: JavascriptEdGraphPin) => void>;
